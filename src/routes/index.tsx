...
function RouteComponent() {
  ...
  return (
    ...
    <ul>
        ...
        <li><strong>Pre-pregnancy weight</strong></li>
        <li><strong>Annual income and socioeconomic status</strong></li>
        <li><strong>History of hypertension, diabetes, or preeclampsia</strong></li>
        <li><strong>Proteinuria levels</strong></li>
        <li><strong>Blood pressure (systolic and diastolic)</strong></li>
        <li><strong>Parity (number of pregnancies)</strong></li>
    </ul>

    <p>Once the data is inputted, the model processes it and provides a prediction: whether you are at risk of developing preeclampsia or not. The result will inform you whether or not you should consult with your healthcare provider for further evaluation and management.</p>

    <p>By offering this personalized risk prediction, the app aims to support individuals in taking early action for their health during pregnancy.</p>
